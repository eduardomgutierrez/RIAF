...
solution = solve_ivp(rhs_w_print,(np.log(rOut),0.23),y0,method='LSODA',events=event,dense_output=True)
...
solution2 = solve_ivp(rhs_w_print,(logr_sonic,np.log(1.1)),y0,method='LSODA',vectorized=False,dense_output=True)
